...
<Card size="xl">
	...
	<form class="overflow-y-auto lg:max-h-[60rem] 2xl:max-h-fit">
		<ChatMsg replays={4} name={Users[2].name} avatar={Users[2].avatar}>
			<p>
				Hello <a
					href="#top"
		...
		<ChatMsg replays={0} name={Users[4].name} avatar={Users[4].avatar}>
			<p>Hello everyone,</p>
			<p>
		...
		<ChatMsg replays={0} name={Users[3].name} avatar={Users[3].avatar}>
			<p>
